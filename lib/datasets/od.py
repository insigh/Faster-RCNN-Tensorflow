...
class od(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'od_' + year + '_' + image_set)
        ...
        self._data_path = osp.join(cfg.DATA_DIR, 'od')
        ...
        od_name = image_set + year  # e.g., "val2014"
        self._data_name = (self._view_map[od_name]
                           if od_name in self._view_map
                           else od_name)
    ...
    def image_path_from_index(self, index):
        ...
        file_name = (self.image_paths[str(index)])
