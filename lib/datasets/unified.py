...
class unified(imdb):
    def __init__(self, image_set, year):
        ...
        self._data_path = osp.join(cfg.DATA_DIR, 'unified')
        ...
        unified_name = image_set + year  # e.g., "val2014"
        self._data_name = (self._view_map[unified_name]
                           if unified_name in self._view_map
                           else unified_name)
